...
- 两个效应相抵触时，“不能”为优先
- 要求做出不可能的动作时，省略该动作（例如，某个效应让你弃一张手牌，若你手上无牌，则不用弃牌）
...
- 宝可梦
  - 左上为进化状态。在场一回合之后，可以将高一级的宝可梦卡放在原来的宝可梦上进化
  - 右上为血量、属性
  - 左下为克制、抗性，右下为撤退费用
- 训练家
  - 物品：每回合使用次数没有限制
  - 宝可梦道具：贴附于宝可梦，一只宝可梦最多贴附一张道具
  - 支援者：先攻第一回合不能用；一回合限一次
- 竞技场：全局仅限一张；任意玩家打出新的一张之后原来的竞技场进入拥有者的弃牌区
- 能量：附着于宝可梦身上使用。一回合只能附着一张
...
1. 起始手牌7张，抽完后将任意数量基础宝可梦反面朝上放进战斗场、备战区（战斗场1只，备战区0~5只）
2. 将牌库顶6张牌反面朝上放入奖赏卡区
3. 将所有宝可梦卡翻到正面并开始对战
...
1. 抽牌阶段
2. 主要阶段：将基础宝可梦放入备战区、进化宝可梦、附着能量（一回合一张）、使用特性、撤退至备战区
3. 战斗阶段：若能量足够，则可以使用一个招式（先攻第一回合不能攻击），对对手战斗场的宝可梦造成伤害；若造成致命伤害则昏厥，将该宝可梦以及其身上附着的能量、道具等全部放入弃牌区，并从奖赏卡区取一张牌
