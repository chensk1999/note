...
[OWASP Top 10](https://owasp.org/Top10/zh_CN/)是开放式Web应用程序安全项目（Open Worldwide Application Security Project，OWASP）统计的危害性最大的10类漏洞

- A01:2021-权限控制失效：越权
- A02:2021-加密机制失效：明文传输敏感信息、使用密钥 / 算法安全性不够
- A03:2021-注入式攻击：将用户输入解析为命令，SQL注入、XSS等
- A04:2021-不安全设计：有缺陷的设计模式，例如报错时默认显示详细信息
- A05:2021-安全设定缺陷
- A06:2021-危险或过旧的组件
- A07:2021-认证及验证机制失效
- A08:2021-软件及资料完整性失效
...
若服务器配置了只能通过域名访问，“关闭”服务器时又只是解除域名解析，没有真正关掉服务器，我们收集到历史域名就能尝试通过此域名访问服务器。历史域名和IP往往不匹配，很可能要在大量候选IP中碰撞出真正的地址，此技术因此得名
